...
<?php
		...
		if (isModEnabled('subtotals') && getDolGlobalString('SUBTOTAL_TITLE_'.strtoupper($this->element))) {
			...
			<?php
			//TODO check if title line and if subtotalST conf is enable
			?>
			<script>
				document.addEventListener("DOMContentLoaded", function () {
					...
					const columns = document.querySelectorAll("#tva_tx, #price_ht, #price_ttc, #qty, #remise_percent, #addline");
					...
					inputsTitle.childNodes.forEach(field => {
						...
						titleInputsToToggle.push(document.querySelector("#addTitleline"))
					});
					...
					inputsSubtotal.childNodes.forEach(field => {
						...
						subtotalInputsToToggle.push(document.querySelector("#addSubtotalline"))
					});
